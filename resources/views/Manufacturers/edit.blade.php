        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('manufacturers.index') }}" enctype="multipart/form-data">
                        Back</a>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('manufacturers.update',$manufacturer->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Years:</strong>
                        <input type="text" name="manufacturerId" value="{{ $manufacturer->years }}" class="form-control"
                            placeholder="years">
                        @error('years')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
